package ai.vital.sql.service.superadmin;
...
public class VitalServiceSuperAdminSql extends
		AbstractVitalServiceSuperAdminImplementation {

	VitalSqlImplementation impl;

	public VitalServiceSuperAdminSql(VitalServiceSqlConfig config) {
		super(new SystemSegment(new VitalSqlSystemSegmentExecutor(new VitalSqlImplementation(new VitalSqlDataSource(VitalServiceSql.toInnerConfig(config))))));
	...
	@Override
	protected VitalStatus _deleteList(VitalTransaction transaction, VitalOrganization organization, VitalApp app, List<URIProperty> uris)
			throws VitalServiceException, VitalServiceUnimplementedException {
		try {
	...
	@Override
	protected ResultList _saveList(VitalTransaction transaction, VitalOrganization organization, VitalApp app, VitalSegment targetSegment,
	...
	@Override
	protected ResultList _callFunction(VitalOrganization organization, VitalApp app, String function,
	...
	@Override
	protected ResultList _selectQuery(VitalOrganization organization, VitalApp app, VitalSelectQuery query)
			throws VitalServiceException, VitalServiceUnimplementedException {
		try {
	...
	@Override
	protected ResultList _graphQuery(VitalOrganization organization, VitalApp app, VitalGraphQuery query)
			throws VitalServiceUnimplementedException, VitalServiceException {
		try {
	...
	@Override
	protected VitalStatus _bulkImport(VitalOrganization organization, VitalApp app, VitalSegment segment,
	...
	@Override
	protected VitalStatus _bulkExport(VitalOrganization organization, VitalApp app, VitalSegment segment,
