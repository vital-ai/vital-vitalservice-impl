package ai.vital.allegrograph.service.superadmin;
...
public class VitalServiceSuperAdminAllegrograph extends AbstractVitalServiceSuperAdminImplementation {

	AllegrographWrapper wrapper;
	
	private VitalServiceSuperAdminAllegrograph( VitalServiceAllegrographConfig cfg) {
		super(new SystemSegment(new AllegrographSystemSegmentExecutor(initWrapper(cfg))));
...
//		if(organization == null) throw new RuntimeException("Organization not found: ${_organization.organizationID}")
	...
	public static VitalServiceSuperAdminAllegrograph create(VitalServiceAllegrographConfig cfg) {
		

		return new VitalServiceSuperAdminAllegrograph(cfg);
	}
	...
	@Override
	protected VITAL_GraphContainerObject _getExistingObjects(VitalOrganization organization, VitalApp app, List<String> uris) throws VitalServiceException {
		try {
