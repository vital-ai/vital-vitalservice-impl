...
import ai.vital.vitalservice.impl.ServiceOperationsImplementation.ServiceOperationExecutorAdminImpl;
...
public abstract class AbstractVitalServiceAdminImplementation implements VitalServiceAdmin, IVitalServiceConfigAware {
	...
	private final static Logger log = LoggerFactory.getLogger(AbstractVitalServiceAdminImplementation.class);
...
//	protected Transaction currentTransaction;
	...
	public AbstractVitalServiceAdminImplementation(SystemSegment systemSegment, VitalOrganization organization) {
...
//		return Collections.emptyList();
	...
	public ResultList get(VitalApp app, GraphContext graphContext, URIProperty uri, boolean cache) throws VitalServiceUnimplementedException, VitalServiceException {
		return getImpl(app, graphContext, Arrays.asList(uri), cache, null);
	...
	protected ResultList getImpl(VitalApp app, GraphContext graphContext, List<URIProperty> uris, boolean cache, List<GraphObjectsIterable> containers) throws VitalServiceUnimplementedException, VitalServiceException {
		...
		if(graphContext == GraphContext.Local) {
			...
			try {
				gos = _getServiceWideList(app, uris);
			} catch (Exception e) {
				throw new VitalServiceException(e);
			}
	...
	protected abstract List<GraphObject> _getServiceWideList(VitalApp app, List<URIProperty> uris) throws VitalServiceException, VitalServiceUnimplementedException;
	
	protected abstract GraphObject _getServiceWide(VitalApp app, URIProperty uri) throws VitalServiceException, VitalServiceUnimplementedException;
	...
	public VitalStatus delete(VitalApp app, URIProperty uri) throws VitalServiceUnimplementedException, VitalServiceException {
		return this.delete(NO_TRANSACTION, app, uri);
	}
	...
	public VitalStatus delete(VitalTransaction transaction, VitalApp app, URIProperty uri) throws VitalServiceUnimplementedException, VitalServiceException {
		if(uri.get().startsWith( URIProperty.MATCH_ALL_PREFIX ) ) {
			...
			return _deleteAll(app, segment);
			//purge cach
		}
		
		return this.delete(transaction, app, Arrays.asList(uri));
	}
	
	protected abstract VitalStatus _deleteAll(VitalApp app, VitalSegment segment) throws VitalServiceException, VitalServiceUnimplementedException;
	...
	public VitalStatus delete(VitalApp app, List<URIProperty> uris) throws VitalServiceUnimplementedException, VitalServiceException {
		return delete(NO_TRANSACTION, app, uris);
	}
	@Override
	public VitalStatus delete(VitalTransaction transaction, VitalApp app, List<URIProperty> uris) throws VitalServiceUnimplementedException, VitalServiceException {
		...
		VITAL_GraphContainerObject existingObjects = _getExistingObjects(app, urisList); 
//		
...
//		List<URIProperty> newList = new ArrayList<URIProperty>(uris);
		...
		if(tempList.size() > 0) {
			try {
				status = _deleteList(transaction, app, tempList);
...
//				}
	...
	protected abstract VitalStatus _deleteList(VitalTransaction transaction, VitalApp app, List<URIProperty> uris)  throws VitalServiceException,
	VitalServiceUnimplementedException;
	...
	public VitalStatus deleteObject(VitalTransaction transaction, VitalApp app, GraphObject object) throws VitalServiceUnimplementedException, VitalServiceException {
		return this.delete(transaction, app, URIProperty.withString(object.getURI()));
	}
	...
	public VitalStatus deleteObjects(VitalTransaction transaction, VitalApp app, List<GraphObject> objects) throws VitalServiceUnimplementedException, VitalServiceException {
		...
		return this.delete(transaction, app, uris);
	}
	...
	public ResultList insert(VitalApp app, VitalSegment targetSegment, GraphObject graphObject) throws VitalServiceUnimplementedException, VitalServiceException {
		return insert(NO_TRANSACTION, app, targetSegment, graphObject);
	}
	...
	public ResultList insert(VitalTransaction transaction, VitalApp app, VitalSegment targetSegment, GraphObject graphObject) throws VitalServiceUnimplementedException, VitalServiceException {
		...
		return this.insert(transaction, app, targetSegment, Arrays.asList(graphObject));
	}
	...
	public ResultList insert(VitalApp app, VitalSegment targetSegment, List<GraphObject> graphObjectsList) throws VitalServiceUnimplementedException, VitalServiceException {
		return insert(NO_TRANSACTION, app, targetSegment, graphObjectsList);
	}	
	...
	public ResultList insert(VitalTransaction transaction, VitalApp app, VitalSegment targetSegment, List<GraphObject> graphObjectsList) throws VitalServiceUnimplementedException, VitalServiceException {
		...
		if(newList.size() > 0) {
			...
			try {
				rl = _saveList(transaction, app, targetSegment, newList);
...
//		}
	...
	protected abstract ResultList _saveList(VitalTransaction transaction, VitalApp app, VitalSegment targetSegment, List<GraphObject> graphObjectsList) throws VitalServiceUnimplementedException, VitalServiceException;

	protected abstract VITAL_GraphContainerObject _getExistingObjects(VitalApp app, List<String> uris) throws VitalServiceException;
	...
	public ResultList save(VitalApp app, VitalSegment targetSegment, GraphObject graphObject, boolean create) throws VitalServiceUnimplementedException, VitalServiceException {
		return this.save(NO_TRANSACTION, app, targetSegment, graphObject, create);
	}
	...
	public ResultList save(VitalTransaction transaction, VitalApp app, VitalSegment targetSegment, GraphObject graphObject, boolean create) throws VitalServiceUnimplementedException, VitalServiceException {
		return this.save(transaction, app, targetSegment, Arrays.asList(graphObject), create);
	}
	...
	public ResultList save(VitalApp app, VitalSegment targetSegment, List<GraphObject> graphObjectsList, boolean create) throws VitalServiceUnimplementedException, VitalServiceException {
		return save(NO_TRANSACTION, app, targetSegment, graphObjectsList, create);
	}
...
//		}
	...
	public ResultList save(VitalApp app, GraphObject graphObject) throws VitalServiceUnimplementedException, VitalServiceException {
		return this.save(NO_TRANSACTION, app, graphObject);
	}
	...
	public ResultList save(VitalTransaction transaction, VitalApp app, GraphObject graphObject) throws VitalServiceUnimplementedException, VitalServiceException {
		return this.save(transaction, app, Arrays.asList(graphObject));
	}
	...
	public ResultList save(VitalApp app, List<GraphObject> graphObjectsList) throws VitalServiceUnimplementedException, VitalServiceException {
		return save(NO_TRANSACTION, app, graphObjectsList);
	}
	...
	public ResultList save(VitalTransaction transaction, VitalApp app, List<GraphObject> graphObjectsList) throws VitalServiceUnimplementedException, VitalServiceException {
		...
		for(Entry<String, List<GraphObject>> entry : segmentToList.entrySet()) {
			...
			try {
				ResultList subRes = _saveList(transaction, app, segment, entry.getValue());
				if(transaction != null && transaction != NO_TRANSACTION) {
	...
	public VitalStatus doOperations(VitalApp app, ServiceOperations operations) throws VitalServiceUnimplementedException, VitalServiceException {
		//verify operations
		try {
			return new ServiceOperationsImplementation(new ServiceOperationExecutorAdminImpl(this, app), operations).execute();
		} catch (Exception e) {
			return VitalStatus.withError(e.getLocalizedMessage());
		}
	...
	public ResultList callFunction(VitalApp app, String function,
		...
		ResultList rl;
		try {
			rl = _callFunction(app, function, arguments);
		} catch (Exception e) {
			rl = new ResultList();
			rl.setStatus(VitalStatus.withError(e.getLocalizedMessage()));
		}
	 ...
	 */
	protected abstract ResultList _callFunction(VitalApp app, String function,
...
//		throw new VitalServiceUnimplementedException("NOT IMPLEMENTED");
		...
		try {
			...
			if( query instanceof VitalExternalSparqlQuery || query instanceof VitalExternalSqlQuery ) {
				...
				return _externalQuery(app,query);
		...
		return new AdminServiceQueryImplementation(systemSegment, query, this, app).handleQuery();
			/*
			if( VitalSegment.isAllSegments(query.getSegments()) ) {
				query.setSegments(listSegments(app));
...
//				} else {
					rl = _graphQuery(app, (VitalGraphQuery) query);
//				}
				addToCache(rl);
				return rl;
...
//				} else {
					rl = _selectQuery(app, (VitalSelectQuery) query);
//				}
				addToCache(rl);
				return rl;
				...
				return new PathQueryImplementation((VitalPathQuery) query, new VitalServiceAdminPathQueryExector(this, app)).execute();
	...
	protected ResultList _externalQuery(VitalApp app, VitalQuery query) {
	...
	protected abstract ResultList _selectQuery(VitalApp app, VitalSelectQuery query) throws VitalServiceException, VitalServiceUnimplementedException;
	 ...
	 * @return
	 */
	protected abstract ResultList _graphQuery(VitalApp app, VitalGraphQuery gq) throws VitalServiceUnimplementedException, VitalServiceException;
	...
	public ResultList getExpanded(VitalApp app, URIProperty uri, boolean cache) throws VitalServiceUnimplementedException, VitalServiceException {
		...
		ResultList rl = this.get(app, GraphContext.ServiceWide, Arrays.asList(uri));
		...
		List<VitalSegment> segments = listSegments(app);
		...
		ResultList res = this.query(app, pq);
		if(cache) {
			addToCache(res);
		}
		return res;
	...
	@Override
	public ResultList getExpanded(VitalApp app, URIProperty uri, VitalPathQuery pq, boolean cache) throws VitalServiceUnimplementedException, VitalServiceException {
		...
		ResultList rl = this.query(app, pq);
		if(cache) {
			addToCache(rl);
		}
		return rl;
	...
	public VitalStatus deleteExpanded(VitalApp app, URIProperty uri) throws VitalServiceUnimplementedException, VitalServiceException {
		return deleteExpanded(NO_TRANSACTION, app, uri);
	...
	public VitalStatus deleteExpanded(VitalTransaction transaction, VitalApp app, URIProperty uri) throws VitalServiceUnimplementedException, VitalServiceException {
		return deleteResults(transaction, app, getExpanded(app, uri, false));
	...
	public VitalStatus deleteExpandedObject(VitalApp app, GraphObject object) throws VitalServiceUnimplementedException, VitalServiceException {
		return deleteExpandedObject(NO_TRANSACTION, app, object);
	...
	public VitalStatus deleteExpandedObject(VitalTransaction transaction, VitalApp app, GraphObject object) throws VitalServiceUnimplementedException, VitalServiceException {
		return deleteResults(transaction, app, getExpanded(app, URIProperty.withString(object.getURI()), false));
	...
	public VitalStatus deleteExpanded(VitalApp app, URIProperty uri, VitalPathQuery query) throws VitalServiceUnimplementedException, VitalServiceException {
		return deleteExpanded(NO_TRANSACTION, app, uri, query);
	}
	...
	public VitalStatus deleteExpanded(VitalTransaction transaction, VitalApp app, URIProperty uri, VitalPathQuery query) throws VitalServiceUnimplementedException, VitalServiceException {
		return deleteResults(transaction, app, getExpanded(app, uri, query, false));
	}
	...
	public VitalStatus deleteExpanded(VitalApp app, List<URIProperty> uris, VitalPathQuery query) throws VitalServiceUnimplementedException, VitalServiceException {
		return deleteExpanded(NO_TRANSACTION, app, uris, query);
	}
	...
	public VitalStatus deleteExpanded(VitalTransaction transaction, VitalApp app, List<URIProperty> uris, VitalPathQuery query) throws VitalServiceUnimplementedException, VitalServiceException {
		...
		return deleteResults(transaction, app, this.query(app, query));
	...
	public VitalStatus deleteExpandedObjects(VitalApp app, List<GraphObject> objects, VitalPathQuery query) throws VitalServiceUnimplementedException, VitalServiceException {
		return deleteExpandedObjects(NO_TRANSACTION, app, objects, query);
	}
	...
	public VitalStatus deleteExpandedObjects(VitalTransaction transaction, VitalApp app, List<GraphObject> objects, VitalPathQuery query) throws VitalServiceUnimplementedException, VitalServiceException {
		...
		return this.deleteExpanded(transaction, app, uris, query);
	}
	
	
	protected VitalStatus deleteResults(VitalTransaction transaction, VitalApp app, ResultList rl) throws VitalServiceUnimplementedException, VitalServiceException {
	...
	@Override
	public final VitalStatus bulkImport(VitalApp app, VitalSegment segment, InputStream inputStream) throws VitalServiceUnimplementedException, VitalServiceException {
	...
	public VitalStatus bulkImport(VitalApp app, VitalSegment segment, InputStream inputStream, String datasetURI)
		...
		return _bulkImport(app, segment, inputStream, datasetURI);
	}

	@Override
	public final VitalStatus bulkExport(VitalApp app, VitalSegment segment, OutputStream outputStream) throws VitalServiceUnimplementedException, VitalServiceException {
...
//		throw new VitalServiceUnimplementedException("NOT IMPLEMENTED");
		return _bulkExport(app, segment, outputStream, datasetURI);
	}

	protected abstract VitalStatus _bulkImport(VitalApp app, VitalSegment segment, InputStream inputStream, String datasetURI) throws VitalServiceUnimplementedException, VitalServiceException;
	protected abstract VitalStatus _bulkExport(VitalApp app, VitalSegment segment, OutputStream outputStream, String datasetURI) throws VitalServiceUnimplementedException, VitalServiceException;
	
	
	

	@Override
	public VitalStatus sendEvent(VitalApp app, final VITAL_Event event, boolean waitForDelivery) throws VitalServiceUnimplementedException, VitalServiceException {
	...
	@Override
	public VitalStatus uploadFile(VitalApp app, URIProperty uri, String fileName, InputStream inputStream,
	...
	@Override
	public VitalStatus downloadFile(VitalApp app, URIProperty uri, String fileName, OutputStream outputStream,
	...
	@Override
	public VitalStatus addDatabaseConnection(VitalApp arg0, DatabaseConnection arg1)
			throws VitalServiceUnimplementedException, VitalServiceException {
		if(getApp(arg0) == null) {
	...
	@Override
	public ResultList listDatabaseConnections(VitalApp arg0)
			throws VitalServiceUnimplementedException, VitalServiceException {
//		if(getApp(arg0) == null) {
//			ResultList rl = new ResultList();
...
//		}
	...
	protected VitalApp getApp(VitalApp app) throws VitalServiceUnimplementedException, VitalServiceException {
	...
	@Override
	public VitalSegment getSegment(VitalApp arg0, String arg1)
			throws VitalServiceUnimplementedException, VitalServiceException {
	...
	@Override
	public final List<VitalSegment> listSegments(VitalApp app) throws VitalServiceUnimplementedException, VitalServiceException {
		return systemSegment.listSegmentsOnly(organization, app);
	}
	
	@Override
	public final ResultList listSegmentsWithConfig(VitalApp app)
			throws VitalServiceUnimplementedException, VitalServiceException {
		return systemSegment.listSegments(organization, app);
	}

	@Override
	public final VitalSegment addSegment(VitalApp arg0, VitalSegment arg1,
	...
	public VitalSegment addSegment(VitalApp app, VitalSegment segment,
			VitalProvisioning provisioning, boolean createIfNotExists)
			throws VitalServiceUnimplementedException, VitalServiceException {
		return systemSegment.addSegment(organization, app, segment, provisioning);
	}

	@Override
	public final VitalStatus addApp(VitalApp app)
			throws VitalServiceUnimplementedException, VitalServiceException {
	...
	@Override
	public final List<VitalApp> listApps() throws VitalServiceUnimplementedException,
			VitalServiceException {
		return systemSegment.listApps(organization);
	}

	@Override
	public final VitalStatus removeApp(VitalApp app)
			throws VitalServiceUnimplementedException, VitalServiceException {
	...
	@Override
	public final VitalStatus removeSegment(VitalApp app, VitalSegment segment,
